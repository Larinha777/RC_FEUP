...
int main(int argc, char *argv[])
{
    ...
    {
        printf("First flag received correctly\n");
    }
    ...
    unsigned char ua_message[BUF_SIZE] = {0};
    ua_message[0] = FLAG;
    ua_message[1] = ADESS_BY_SENDER;
    ua_message[2] = CONTROL_UA;
    ua_message[3] = ADESS_BY_SENDER ^ CONTROL_SET;
    ua_message[4] = FLAG;
